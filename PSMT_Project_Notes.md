...
- **2026-08-12 — Catalog/card redesign Step 6:** Docs close-out — COMPLETE entry, backlog #1/#5 closures, tablet drop, new deferred items, Role/Label status refresh. Files: this Notes only (README/Quickstart batched). Rollback `3e4dedd`.

- **2026-08-12 — Catalog/card redesign COMPLETE + session decisions.**

  **CONTEXT:** Catalog/card redesign Steps **1–5b** shipped on `psmt-overhaul` this effort. This Step 6 docs close-out records completions, closures, and new logged items. README/Quickstart remain batched until the next version bump.
  ...
  **STATUS:** **COMPLETE.** Redesign Steps **1–5b** shipped; this entry is the docs close-out. Remaining operator-doc sync (README/Quickstart) is the next separate batched commit at version bump.
