...
- **15.** Status/mode readout — map-floating ongoing-state readout **SHIPPED (b66ee21)**; toast one-offs **SHIPPED (b1fb43b)**; Start Here / idle instructional **SHIPPED (802c1b3)**. Item **15** is now fully resolved pending only Tier C Step 5 (`#mode-display` removal). Remains a symptom of item **11**; see Decisions, 2026-08-08 (lock) and 2026-08-10 (Steps 1/3/4).
