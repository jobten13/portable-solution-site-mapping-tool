...
| Model | Spec source | Spec dimensions | Area | Shape | Tool current |
|-------|-------------|-----------------|------|-------|--------------|
| **Generator 70 kVA (on trailer)** | **MQP3Generators** (3-phase product line; bare-unit dimensions on sheet) and **DCA70SSJU4F-03-Trailer-Data-Sheet-TRLR75XF2.pdf** (TRLR75XF2 tandem-axle trailer: **151.3" × 69.3"** overall; **100-gal** fuel cell). Both in Western Shelter & Third Party folder. | Catalog **on-trailer** footprint **14.12' × 6.04'** L×W from MQ Power generator/trailer spec sheets; dimensions vary by trailer variant — tool retains the **larger** figure as the conservative planning footprint. 70 kVA. **Developer-verified against physical unit 2026-08-18:** 56 kW, **103 gal** total fuel (generator + trailer tank). Isuzu Tier 4. No per-model-number reconciliation (engine/trailer prefix variants). | — | rect | 14.12 × 6.04 ✓ (`TENT_DB` key **Power**; id `ws-generator-70kva` unchanged). Relocated from Western Shelter 2026-08-12. |
...
8b. **Power — Generator 70 kVA on trailer**: 14.12'×6.04' conservative on-trailer footprint (MQ Power **MQP3Generators** + **TRLR75XF2** sheets; trailer-variant variance — larger retained); 56 kW / 103 gal total fuel verified on physical unit 2026-08-18. Catalog tab **Power** (planning grouping; specs from Western Shelter & Third Party folder — procurement history). Relocated from Western Shelter tab 2026-08-12.
...
- **Western Shelter & Third Party**: Spec Sheets — SW-1935.pdf, SW-2342_Shelter.pdf, SW-2360.pdf, Guardian_2032x3065.pdf, DCA70SSJU4F-03-Trailer-Data-Sheet-TRLR75XF2.pdf (**TRLR75XF2** tandem-axle trailer: 151.3"×69.3" overall, 100-gal fuel cell), **MQP3Generators** (3-phase line; bare-unit dimensions). Instructions — WS_GK1935 Set Up, WS_GK20 Set Up, GK+Vestibule, Vestibule+Entryway. **SO-VC8H** vestibule footprint (7'8"×7'4") and sidewall height per Western Shelter SO-VC8H spec. Product catalog: Western-Shelter-_-Product-Catalog.pdf. (Generator MQ Power sheets live in this folder; catalog tab is **Power**.)
- **Power (catalog tab):** Generator 70 kVA — **MQP3Generators** + **TRLR75XF2** sheets as above; catalog footprint 14.12'×6.04' conservative (trailer-variant variance; larger retained); 56 kW / 103 gal total fuel verified on physical unit 2026-08-18. Grouping is planning (serves any vendor), not procurement.
...
| **Power** | Pseudo-vendor catalog tab (not an OEM). Generator 70 kVA: **MQP3Generators** (3-phase, bare-unit dims) + **TRLR75XF2** trailer sheet (151.3"×69.3" overall, 100-gal fuel cell) in Western Shelter & Third Party folder. Catalog footprint 14.12'×6.04' — conservative planning figure from generator/trailer specs (trailer-variant variance; larger retained). 56 kW / 103 gal total fuel verified on physical unit 2026-08-18. `TENT_DB` key **Power**; id `ws-generator-70kva`. Tool current: ✓. |
